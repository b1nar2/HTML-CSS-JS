...
-- 13628
-- 경기도 성남시 분당구 미금로 177 (구미동, 까치마을)
-- 경기도 성남시 분당구 구미동 66 까치마을
-- 상세주소 범위 : 101~116동 1~19층  01 ~ 04호 ex) 1703호

-- 13625
-- 경기도 성남시 분당구 미금로 23 (구미동, 무지개마을)
-- 경기도 성남시 분당구 구미동 211 무지개마을
-- 상세주소 범위 : 101~111동 1~15층 01 ~ 04호 ex) 1301호
...
BEGIN  
      ...
      apt_addresses := APT_ADDRESS_TBL(
            ...
            apt_address_record_constructor('08750',        
                    ...
                    '서울특별시 관악구 봉천동 1708 두산아파트',
                    ''),
            apt_address_record_constructor('13628',        
                    '경기도 성남시 분당구 미금로 177 (구미동, 까치마을)',
                    '경기도 성남시 분당구 구미동 66 까치마을',
                    ''),
            apt_address_record_constructor('13625',        
                    '경기도 성남시 분당구 미금로 23 (구미동, 무지개마을)',
                    '경기도 성남시 분당구 구미동 211 무지개마을',
                    '')                
    ...
    FOR i IN 1..100 LOOP  
         ...
         */
            ...
            ELSIF temp_num = 6 THEN    
                    ...
                    -- 상세주소 범위 : 101~116동 1~19층  01 ~ 04호 ex) 1703호
                    temp_dong := round(DBMS_RANDOM.VALUE(101,116),0) || '동';
                    
                    temp_ho := round(DBMS_RANDOM.VALUE(10,19),0) || 
                               round(DBMS_RANDOM.VALUE(0,1),0) || 
                               round(DBMS_RANDOM.VALUE(1,4),0) || '호';   
                               
            ELSE 
                 -- 7번 : 경기도 성남시 분당구 미금로 23 (구미동, 무지개마을)
                 -- 상세주소 범위 : 101~111동 1~15층 01 ~ 04호 ex) 1301호 
                    temp_dong := round(DBMS_RANDOM.VALUE(101,111),0) || '동';
