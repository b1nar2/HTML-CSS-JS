    ...
    //////////////////////////////////////////////////////////////////
     ...
     wear_gallery_pics.forEach((element) => {
        ...
        close_btn.addEventListener('click', () => {
            ...
            // Swiper JS 적용 : https://swiperjs.com/get-started#initialize-swiper

            const swiper = new Swiper('.swiper', {
                // Optional parameters
                // direction: 'vertical', //세로전개
                // direction 속성 : https://swiperjs.com/swiper-api#parameters
                direction: 'horizontal', // 기본값(가로)
                loop: true,
