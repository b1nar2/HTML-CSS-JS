...
function BootstrapForm() {
    ...
    // 상담내용 폼 점검
    const formDescriptionCheck = async(e : Event) => {
        let descriptionFld : HTMLTextAreaElement 
            = document.getElementById("description") as HTMLTextAreaElement;
        let descriptionRegex : RegExp = /^[0-9a-zA-Z가-힣ㄱ-ㅎ\W]{2,}$/; // 최소 2글자 이상
        console.log("description.value :" , description.value);

        if (descriptionRegex.test(descriptionFld.value) == true) {
            ...
            <div className="member-wrap">
                ...
                <div className="input-fld-pnl">
                    ...
                    <Input id="description" name="description" 
                            type="textarea" style={{resize:"none", height:"150px"}} onChange={(e) => formDescriptionCheck(e)} />
                ...
                <div className="btn-fld-pnl mt-3">
                    ...
                    <div className="mx-3">
                        ...
                        <Button onClick={(e : Event) => formSubmit(e)}  color="primary" outline>전송</Button>
                    </div>

                    <div>
                        {/* <!-- 폼 초기화 기능 추가 --> */}
                        <Button onClick={(e : Event) => formatInit(e)} color="primary" outline>취소</Button>
                    </div>
