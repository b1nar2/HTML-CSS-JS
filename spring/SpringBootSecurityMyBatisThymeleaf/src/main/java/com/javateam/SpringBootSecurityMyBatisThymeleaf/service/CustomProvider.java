...
public class CustomProvider 
	...
	private List<Role> loadUserRole(String username) {
		...
		try {
			...
			log.error("loadUserRole error : " + e);
	    	return null;
	    }
