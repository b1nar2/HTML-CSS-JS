...
@MapperScan(basePackages="com.javateam.SpringJstlELDemo.mapper")//, 
...
//	} //
	...
	public SqlSessionFactory getSqlSessionFactoryBean() throws Exception {
		...
		ssfb.setTypeAliasesPackage("com.javateam.SpringJstlELDemo.domain");
		// ssfb.setDataSource(this.getDataSourceJDBC());
		ssfb.setDataSource(this.getDataSourceDBCP());
